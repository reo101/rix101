...
in
{
  ...
  options = {
    rix101.scm = {
      git = {
        enable = mkEnableOption "rix101 git setup";
      };
      jj = {
        enable = mkEnableOption "rix101 jj setup";
      ...
      programs.jujutsu = mkIf cfg.jj.enable {
        ...
        settings = {
          ...
          remotes = {
            ...
            # upstream.auto-track-bookmarks = "trunk()";
          };
          signing = {
            backend = "gpg";
            behavior = "drop";
          ...
          template-aliases = {
            ...
            '';
            "format_short_commit_header(commit)" = /* jj_template */ ''
              separate(" ",
